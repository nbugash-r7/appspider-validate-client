...
var AppSpiderValidate = {
    ...
    * */
    ...
    updateAttack: function(from, attack_id) {
    ...
    getCookies: function(attack_id, callback){
        AppSpiderValidate.retrieveAttack(attack_id,function(results){
            /* GET the cookies */
            callback(results.attack_request_header["COOKIE"]);
        });
    },
    setCookies: function(attck_id, cookies){
        AppSpiderValidate.retrieveAttack(attack_id,function(results){
            /* GET the cookies */
